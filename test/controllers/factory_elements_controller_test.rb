...
class FactoryElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create factory_element' do
    assert_difference('FactoryElement.count') do
      post factory_elements_url, params: {
        factory_element: {
          branch_id: @factory_element.branch_id,
          name: @factory_element.name,
          state: @factory_element.state
        }
      }, as: :json
    end
  ...
  test 'should update factory_element' do
    patch factory_element_url(@factory_element), params: {
      factory_element: {
        branch_id: @factory_element.branch_id,
        name: @factory_element.name,
        state: @factory_element.state
